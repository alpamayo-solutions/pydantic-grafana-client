...
class Teams(Base):
    ...
    def add_team(self, team):
        ...
        add_team_path = "/teams"
        return self.client.POST(add_team_path, json=payload)
    ...
    def update_team(self, team_id, team):
        ...
        return self.client.PUT(update_team_path, json=payload)
    ...
    def add_team_external_group(self, team_id, group):
        ...
        team_group_path = "/teams/%s/groups" % team_id
        return self.client.POST(team_group_path, json=payload)
