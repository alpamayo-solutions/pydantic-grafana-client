...
class ServiceAccount(Base):
    ...
    def create(self, service_account):
        ...
        return self.client.POST(create_service_account_path, json=payload)
    ...
    def update(self, service_account_id, service_account):
        ...
        return self.client.PATCH(path, json=payload)
    ...
    def create_token(self, service_account_id, content):
        ...
        return self.client.POST(create_service_account_token_path, json=payload)
