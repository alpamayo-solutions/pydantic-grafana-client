...
class AlertingProvisioning(Base):
    ...
    async def create_alertrule(
        ...
        return await self.client.POST(create_alertrule_path, json=payload, headers=headers)

    async def update_alertrule(
        self,
        alertrule_uid: str,
        ...
        if disable_provenance:
            headers["X-Disable-Provenance"] = "true"
        payload = AlertRuleModel.validate(alertrule).to_payload()
        return await self.client.PUT(update_alertrule_path, json=payload, headers=headers)
    ...
    async def update_rule_group(
        ...
        return await self.client.PUT(update_rule_group_path, json=payload, headers=headers)
    ...
    async def create_contactpoint(
        ...
        return await self.client.POST(create_contactpoint_path, json=payload, headers=headers)

    async def update_contactpoint(
        ...
        payload = ContactPointModel.validate(contactpoint).to_payload()
        return await self.client.PUT(update_contactpoint_path, json=payload)
    ...
    async def set_notification_policy_tree(
        self,
        ...
        return await self.client.PUT(set_notification_policy_tree_path, json=payload, headers=headers)
    ...
    async def create_mute_timing(
        ...
        return await self.client.POST(create_mute_timing_path, json=payload, headers=headers)

    async def update_mute_timing(
        self, mutetiming_name: str, mutetiming: Union[MuteTimingModel, Mapping[str, Any]]
    ) -> dict:
        """
        ...
        payload = MuteTimingModel.validate(mutetiming).to_payload()
        return await self.client.PUT(update_mute_timing_path, json=payload)
    ...
    async def create_or_update_template(
        ...
        return await self.client.PUT(create_template_path, json=payload, headers=headers)
