...
class Organization(Base):
    ...
    async def update_current_organization(
        ...
        return await self.client.PUT(update_current_organization_path, json=payload)
    ...
    async def update_user_current_organization(
        ...
        return await self.client.PATCH(update_user_current_organization_path, json=payload)
...
class Organizations(Base):
    ...
    async def update_organization(
        ...
        return await self.client.PUT(update_org_path, json=payload)
    ...
    async def organization_user_update(self, organization_id: int, user_id: int, user_role: str) -> dict:
        ...
        return await self.client.PATCH(patch_user, json=payload)
