...
class DashboardVersions(Base):
    ...
    async def restore_dashboard(
        self, dashboard_id: int = None, dashboard_uid: str = None, version_id: int = None
    ) -> dict:
        api_path = await self.api_path(dashboard_id=dashboard_id, dashboard_uid=dashboard_uid)
        ...
        return await self.client.POST(restore_dashboard_path, json=payload)
    ...
    async def calculate_diff(
        ...
        return await self.client.POST(calculate_diff_path, json=payload)
